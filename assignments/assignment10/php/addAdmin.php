...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      if($result == "error"){
        ...
        return getForm("<p>Admin Information Successfully Added</p>", $elementsArr);
      }
...
<br>
    ...
    <div style='padding-top:15px; text-align:center;' class='form-group-row'><a href='index.php?page=welcome' class='btn btn-primary btn-sm active' role='button' aria-pressed='true'>Back to Home</a></div>
